...
#         self.templates = {
#             "informative": """
# Write a LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "casual": """
# Write a casual LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "inspirational": """
# Write an inspirational LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "professional": """
# Write a professional LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "motivational": """
# Write a motivational LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "witty": """
# Write a witty and clever LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "direct": """
# Write a direct, no-fluff LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "narrative": """
# Write a story-style narrative LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "concise": """
# Write a concise, short LinkedIn post in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
# """,
#             "technical": """
# Write a technical LinkedIn post with industry insights in {language} about: {prompt}
# Tone: {tone}
# Approximate length: {words} words.
# {hashtags}
# {emojis}
...
#         for _ in range(variations):
#             prompt_template = PromptTemplate(
#                 input_variables=["prompt", "tone", "words", "hashtags", "emojis", "audience", "cta", "language"],
#                 template=self.templates[template],
#             )
#             chain = prompt_template | self.llm
